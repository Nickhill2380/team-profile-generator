...
FileGenerator.prototype.cardGenerator = function (team) {
   ...
   for( i= 0; i < team.length; i++) {
        ...
        staff += `
                    ...
                    ${team[i].name}
                    <p>
                    ${this.specialIcon(team[i])}${team[i].role}
                    </p>
                    </h2>
                    <p>
                    ID:${team[i].id}
...
FileGenerator.prototype.specialIcon = function (employee) {

    if(employee.role === 'Manager') {
        return `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
        ...
        return `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bug" viewBox="0 0 16 16">
        ...
        return `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-headphones" viewBox="0 0 16 16">
